...
public class Transaction {
   ...
   JButton EnterButton = new JButton();
    ...
    Transaction(String temp1, String temp2, String temp3,Color Dark) throws IOException {

        CheckTheme(temp1,temp2,temp3,Dark);
    ...
    void TransactionMethod(String temp1, String temp2, String temp3)  {
        ...
        AccountNoField.addKeyListener(new KeyAdapter() {
            ...
            public void keyPressed(KeyEvent e) {
                if(e.getKeyCode()==KeyEvent.VK_ENTER)
                {
                    ...
                    {
                        EnterToTransactionPanel(temp1,temp2,temp3);
                    }
                }
            }
        });
...
//                String line = "";
//
//                String CheckAccountNo=String.valueOf(AccountNoField.getText());
//                System.out.println(CheckAccountNo);
//
//                try {
...
//                        if(row[0].contains(CheckAccountNo))
//                        {
//                                    temp1=row[0];
//                                    temp2=row[1];
//                                    temp3=row[2];
//                            frame.dispose();
//                           new TransactionDetail( temp1,  temp2,  temp3,frame.getContentPane().getBackground());
...
//
////                frame.dispose();
////                 new TransactionDetail(frame.getContentPane().getBackground());
//
//            }
    ...
    void EnterToTransactionPanel(String temp1, String temp2, String temp3)
    {
        String File = "database.csv";
        BufferedReader reader = null;
        String line = "";
...
//                          System.out.println(row[2]);
    ...
    void CheckTheme(String temp1, String temp2, String temp3,Color dark)
    {
        ...
        if(dark.equals(new Color(24, 30, 40))) {
            ...
            bF = 20;
//            frame.getContentPane().setBackground(new Color(rB, gB, bB));
            TransactionMethod(temp1,temp2,temp3);
        }
